...
<main>
    <table>
        ...
        <tbody>
        @foreach($subscriptions as $key => $subcription)
            <?php
                 $date1 = new DateTime($subcription->created_at);
                 $date2 = new DateTime($subcription->ends_at);
                 ...
                 $amount = $plans[$subcription->name]->amount/100;
                 $productTotal = $amount*$month;
                 $subTotal += $productTotal;
            ?>
        <tr>
            <td class="service">{{ $plans[$subcription->name]->nickname }}</td>
            <td class="desc"></td>
            <td class="unit">{{ $amount }} €</td>
            <td class="qty">{{ $month }}</td>
        ...
        <tr>
            <td colspan="4">TVA</td>
            <td class="total">{{ $tva = $subTotal*0.20 }} €</td>
        </tr>
        <tr>
            <td colspan="4" class="grand total">TOTAL</td>
            <td class="grand total">{{ $subTotal+$tva }} €</td>
        </tr>
        </tbody>
    </table>
    <div id="notices">
