        ...
        <div class="row">
            ...
            <div class="col-lg-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        @if(strpos($subscribers->name, 'simple') === false)
                            <a href="/changer-offre/{{ auth()->user()->getRememberToken() }}/2" class="btn btn-primary">Choisir cet offre</a>
                        @else
                            <a href="/desabonnement/{{ auth()->user()->getRememberToken() }}" class="btn btn-primary">Me désabonner</a>
                        @endif
                    </div>
                </div>
            </div>
            <div class="col-lg-4 mb-4">
                <div class="card h-100">
                    ...
                    <div class="card-footer">
                        @if(strpos($subscribers->name, 'resident') === false)
                            <a href="/changer-offre/{{ auth()->user()->getRememberToken() }}/3" class="btn btn-primary">Choisir cet offre</a>
                        @else
                            <a href="/desabonnement/{{ auth()->user()->getRememberToken() }}" class="btn btn-primary">Me désabonner</a>
                        @endif
                    </div>
