            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12 col-sm-12 col-xs-12" align="center">
                        ...
                        <h1 align="center">S'abonner</h1>
                        <br>


                        <div>
                            <form action="/sabonner" method="POST">
                            @csrf
                            ...
                            <div class="formule">
                                ...
                                <div class="col-md-5 col-sm-5 col-xs-5 card-offer">

                                    <i class="fas fa-question-circle" id="offerInfo2"></i>
                                    <a href="/sabonner/2" class="card-link">
                                ...
                                <div class="col-md-5 col-sm-5 col-xs-5 card-offer">
                                    ...
                                    <a href="/sabonner/3" class="card-link">
                            ...
                            @if(isset($offer))
                                <div id="engagement" class="engagement">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-5 card-engagement">
                                        <a href="/sabonner/{{ $offer }}/0" class="card-link-engagement">
                                    ...
                                    <div class="col-md-5 col-sm-5 col-xs-5 card-engagement">
                                        <a href="/sabonner/{{ $offer }}/1" class="card-link-engagement">
